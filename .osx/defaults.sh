...
# Add Login Screen Note
sudo defaults write /Library/Preferences/com.apple.loginwindow LoginwindowText "Property of August Ash. If found contact 952 851 9400."
